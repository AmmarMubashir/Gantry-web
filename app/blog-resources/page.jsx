...
const BlogResources = () => {
  ...
  return (
    <>
      ...
      <div className="w-full flex items-center justify-between px-[10px] md:px-[2rem] py-[1.5rem] h-[80px] bg-[#01efff] ">
        <div className="text-[22px] font-[600] text-black uppercase tracking-wider">
          <Link href="/">gantry</Link>
        </div>
        <div className="navigation" ref={menuRef} onClick={toggleMenu}>
          <div className="flex justify-between gap-[4rem] items-center bg-[#01efff] lg:bg-[#01efff] menu">
            <ImCross className="w-[20px] h-[20px] lg:hidden  text-black absolute top-[2rem] left-[2rem]" />
            <Link href="/">
              <li className="text-[18px] font-[600] text-black  list-none lg:list-disc">
                Product
              </li>
            </Link>
            <Link href="/">
